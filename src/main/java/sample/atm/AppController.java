...
public class AppController {
    ...
    private void displayWelcomeMessage() {
        displayTextArea.setText("   WELCOME TO THE XYZ ATM!! \n"+
    ...
    private void showMoney(boolean empty) throws FileNotFoundException {
        ...
        if(empty){
            imageLocation = new FileInputStream("src/main/resources/atm-empty.png");
        }else {
            imageLocation = new FileInputStream("src/main/resources/atm-with-cash.png");
        }
